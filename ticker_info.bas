Sub ticker_info():
    ...
    For Each ws In ActiveWorkbook.Worksheets
        ...
        For i = 3 To LastRow
            ...
            ' Requirements ask to read/store open/close val of each row
            ' I don't use these always, but will read them, just to satisfy
            ' Every ticker and vol value is already read/stored
            ...
            ElseIf curr_ticker <> curr_summary_ticker Then
                ...
                '' Checking if greatests need to be updated (BONUS)
